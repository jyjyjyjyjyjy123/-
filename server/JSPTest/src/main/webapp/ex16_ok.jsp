...
<%
	...
	//1. request.getParameter() 동작불능
	//2. request.getParameterValues() 동작불능
	...
	//reqeust > MultipartRequest > 객체 생성
	try {
		...
		//데이터 수신
		//name = reqeust.getParameter("name");
...
<body>
	...
	-->
	<div>
		<a href="/jsp/files/<%= filename %>"><%= filename %></a>
	</div>
	<!--
	...
	-->
	<div>
		<a href="/jsp/files/<%= filename %>" download><%= filename %></a>
	</div>
	<!--
	...
	-->
	<div>
		<a href="download.jsp?filename=<%= filename %>&orgfilename=<%= orgfilename %>" ><%= filename %></a>
	</div>
