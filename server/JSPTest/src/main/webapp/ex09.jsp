...
<body>
	...
	<table class="vertical">
		<tr>
			<th>너비(px)</th>
			<td><input type="number" name="width" min="50" max="300" step="10"></td>
		</tr>
		<tr>
			<th>높이(px)</th>
			<td><input type="number" name="height" min="50" max="300" step="10"></td>
		</tr>
		<tr>
			<th>텍스트</th>
		...
		<tr>
			<th>글자색</th>
			<td><input type="color" name="textcolor" value="#99999" style="height:40px"></td>
		</tr>
		<tr>
			<th>글자 크기(px)</th>
