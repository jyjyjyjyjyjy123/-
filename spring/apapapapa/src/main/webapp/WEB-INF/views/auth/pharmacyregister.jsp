									...
									<div id="my-info">
										...
										<div id="my-info-input">
											<div class="my-info-input-child">
												<input type="text" name="pharmacyName" value="아무약국" required>
											</div>
											<div class="my-info-input-child">
											...
											<div class="my-info-input-child">
												<input type="text" name="pharmacyId" value="jhw02043" required>
											</div>
											<div class="my-info-input-child">
												<input type="password" name="pharmacyPw" value="!52Ekdrms"
													required>
											</div>
											<div class="my-info-input-child">
